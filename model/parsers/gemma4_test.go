...
func TestParseGemma4ToolCall_RepairsIssue15315Examples(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// Source: https://github.com/borism/ollama-cluster/issues/15315#issue-4203625511
		...
		},
		{
			...
			tools:   []api.Tool{gemma4TestStringTool("bash", "command")},
			// Source: https://github.com/borism/ollama-cluster/issues/15315#issuecomment-4194547092
			want: api.ToolCall{
				Function: api.ToolCallFunction{
					Name: "bash",
					Arguments: testArgs(map[string]any{
